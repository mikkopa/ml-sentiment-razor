...
namespace SentimentRazorML.ConsoleApp
{
    public static class ModelBuilder
    {
        ...
        public static async Task CreateModel()
        {
            ...
            // note the different working directory behavior with Visual Studio and dotnet run command
            // https://github.com/dotnet/project-system/issues/3619
            // TRAIN_DATA_FILEPATH needs fixing for it to work in dotnet run -> use GetAbsolutePath()
        ...
        public static string GetAbsolutePath(string relativePath)
        {
            ...
            System.Console.WriteLine($"absolutepath={assemblyFolderPath}");
